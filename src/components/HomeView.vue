  ...
  <div class="bg-[#221010] text-white">
    ...
    <section class="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div class="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <RouterLink to="/calendar" class="bg-red-700 hover:bg-red-600 px-7 py-3 rounded font-medium transition-colors">
            Ver Cartelera
          </RouterLink>
          <RouterLink to="/about" class="border border-white/30 hover:border-white px-7 py-3 rounded font-medium transition-colors">
            Conoce la Compañía
          </RouterLink>
        </div>
      </div>
    ...
    <section class="bg-[#1a0a0a] border-y border-red-900/30 py-10">
      <div class="max-w-5xl mx-auto px-6 grid grid-cols-3 gap-6 text-center">
        ...
        <div>
          <p class="text-4xl font-bold text-red-500">15K</p>
          <p class="text-gray-400 text-sm mt-1">Espectadores</p>
        </div>
      </div>
    </section>
      ...
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <div class="rounded-lg overflow-hidden">
          <img
            ...
            alt="La Sombra del Silencio"
            class="w-full h-80 object-cover"
          />
        </div>
        <div>
          <span class="bg-red-700/30 text-red-400 text-xs font-semibold px-3 py-1 rounded-full uppercase tracking-wider">
            En Cartelera
          </span>
          <h3 class="text-3xl font-bold mt-4 mb-3">La Sombra del Silencio</h3>
          <p class="text-gray-400 leading-relaxed mb-6">
            Una exploración profunda sobre los secretos familiares y el peso de las palabras no dichas a través de tres generaciones. Una obra que te dejará sin aliento.
          </p>
          ...
          <RouterLink to="/calendar" class="bg-red-700 hover:bg-red-600 px-6 py-3 rounded font-medium transition-colors inline-block">
            Comprar Entradas
          </RouterLink>
        </div>
      </div>
    ...
    <section class="bg-[#1a0a0a] py-20">
      <div class="max-w-7xl mx-auto px-6">
        <div class="flex items-center justify-between mb-10">
          ...
          <RouterLink to="/calendar" class="text-red-400 hover:text-red-300 text-sm transition-colors flex items-center gap-1">
    ...
    <section class="max-w-7xl mx-auto px-6 py-20">
      <div class="grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p class="text-gray-400 leading-relaxed mb-6">
            G.T. San Félix de Valdesoto nació para ofrecer un espacio profesional donde actores, técnicos y escritores aficionados puedan explorar su arte. Más de 16 años creando magia sobre el escenario en Madrid.
          </p>
          <RouterLink to="/about" class="text-red-400 hover:text-red-300 font-medium flex items-center gap-1 transition-colors">
    ...
    <footer class="bg-[#0f0505] border-t border-red-900/30 py-12">
      <div class="max-w-7xl mx-auto px-6">
        <div class="grid md:grid-cols-4 gap-8 mb-10">
          <div class="md:col-span-2">
            ...
            <p class="text-gray-500 text-sm leading-relaxed max-w-xs">
              Llevamos la magia del teatro a cada rincón. Compañía dedicada a la excelencia artística y la divulgación cultural en Madrid.
            </p>
          </div>
          <div>
            ...
            <ul class="flex flex-col gap-2 text-sm text-gray-500">
              <li><RouterLink to="/" class="hover:text-white transition-colors">Inicio</RouterLink></li>
              <li><RouterLink to="/about" class="hover:text-white transition-colors">Compañía</RouterLink></li>
              <li><RouterLink to="/repertoire" class="hover:text-white transition-colors">Repertorio</RouterLink></li>
              <li><RouterLink to="/calendar" class="hover:text-white transition-colors">Cartelera</RouterLink></li>
            </ul>
          </div>
          <div>
        ...
        <div class="border-t border-red-900/20 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-gray-600">
