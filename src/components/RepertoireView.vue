  ...
  <div class="bg-[#f8f6f6] text-slate-900">
    ...
    <section class="relative py-20 bg-[#C2B280]/10 border-b border-[#C2B280]/20 overflow-hidden">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-6">
        <p class="text-[#C2B280] text-sm font-semibold uppercase tracking-widest mb-3">Obras</p>
      ...
      <div class="max-w-7xl mx-auto px-6 py-3 flex items-center gap-3 flex-wrap">
        <button
          ...
          :class="[
            ...
            activeCategory === cat
              ? 'bg-[#C2B280] text-slate-900'
              : 'text-slate-600 hover:text-slate-900 border border-transparent hover:border-[#C2B280]/20',
          ]"
        ...
        <div class="ml-auto flex items-center gap-2">
          <button
            ...
            :key="v"
            :class="['p-2 rounded transition-colors', gridView === v ? 'bg-[#C2B280]/40 text-[#C2B280]' : 'text-slate-500 hover:text-slate-900']"
            @click="gridView = v"
          >
    ...
    <section class="max-w-7xl mx-auto px-6 py-12">
      ...
      <ApiState :loading="loading" :error="error">
        ...
        <div v-if="gridView === 'grid'" class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div class="relative overflow-hidden h-52 bg-[#C2B280]/5">
              ...
              <span class="absolute top-3 right-3 bg-[#C2B280]/80 text-slate-900 text-xs px-2 py-1 rounded-full">
                {{ play.genre }}
              </span>
            </div>
            <div class="p-5">
        ...
        <!-- Empty state -->
        <div v-if="filteredPlays.length === 0 && !loading" class="text-center py-20 text-slate-600">
    ...
    <section class="bg-[#C2B280]/10 border-t border-[#C2B280]/20 py-16">
      <div class="max-w-2xl mx-auto px-6 text-center">
        ...
        <RouterLink to="/contact" class="bg-[#C2B280] hover:bg-[#aa9668] text-slate-900 px-8 py-3 rounded font-medium transition-colors inline-block">
